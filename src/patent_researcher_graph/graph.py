...
patent_research_builder.add_edge("derive_sub_research_fields", END)
"""
...
patent_research_graph = patent_research_builder.compile(interrupt_before=[END], checkpointer=patent_research_memory)