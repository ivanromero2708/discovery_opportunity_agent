...
Task: Review the provided main domains and, using the region information and strategic objectives, generate sub-fields that reflect distinct regional or market focus.
...
Task: Review the given main domains and, using the provided Product/Services and Strategic Objectives, and generate sub-fields that categorize the research based on their end applications.
